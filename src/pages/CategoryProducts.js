    ...
    return (
        ...
        <IonPage id="category-page" className={styles.categoryPage}>
                ...
                <IonToolbar>
                    <IonButtons slot="start">
                        <IonButton color="dark" text={category.name} routerLink="/" routerDirection="back">
                            <IonIcon color="dark" icon={chevronBackOutline} />&nbsp;Restaurants
                        </IonButton>
                    </IonButtons>
            ...
            <IonContent fullscreen>
                ...
                <IonSearchbar className={styles.search} onKeyUp={search} placeholder="Search" searchIcon={searchOutline} animated={true} />
